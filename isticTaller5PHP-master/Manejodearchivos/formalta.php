...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      .bg-dark {
    background-color: #9a5445!important;
}
    </style>
  </head>
...
include "menu.php"
  ?>
    ...
    <main role="main" class="container  ">
      ...
      <div class="starter-template" style="background: cadetblue;">
       <form action="alta.php" method="post" enctype="multipart/form-data">

		<div class="form-group" text-align: right>
			<label class="animated bounceIn" for="exampleInputEmail1">Nombre</label>
		...
		<div class="form-group" text-align: right>
			...
			<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Clave alfanumerica" name="clave">
		</div>	
    ...
    <div class="form-group" text-align: right>
      <label for="exampleInputPassword1"   text-align: right>Clave</label>
      <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Clave alfanumerica" name="fecha de nacimiento ">
    </div>

        <input type="file" name="foto"  class="MiBotonUTN"  /> 
